...
!--------------------------------------------------------
  ...
  !if(timer%tstep_continue>=timer%hist_start_yr)then
     ...
     !write(*,*) 'TJ in hist_wrap: hr, day, week, month, year: '
     !write(*,*) timer%its_a_new_hour(), timer%its_a_new_day(), timer%its_a_new_week(), timer%its_a_new_month(), timer%its_a_new_year()
     !write(*,*) clock_hour, clock_day, clock_week, clock_month, clock_year
...
!--------------------------------------------------------
  ...
  !write(*,*)'TJ in hist_create, Checking freq:',freq    !year
