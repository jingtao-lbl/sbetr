# Install script for directory: /global/homes/j/jingtao/ReSOM/sbetr/src/math_test
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/robertson" AND
    ...
    file(RPATH_CHANGE
         ...
         NEW_RPATH "/usr/local/lib:/opt/cray/pe/netcdf/4.9.0.9/intel/2023.2/lib")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/robertson")
    endif()
  endif()
endif()

if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/global/homes/j/jingtao/ReSOM/sbetr/build/src/math_test/CMakeFiles/robertson.dir/install-cxx-module-bmi-noconfig.cmake" OPTIONAL)
endif()
