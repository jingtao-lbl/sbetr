...
#line 18 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
  call assertEqual(1.0_r8, heviside(0.2_r8), &
 & location=SourceLocation( &
 & 'test_betr_mathfunc.pfunit', &
 & 18) )
  if (anyExceptions()) return
#line 19 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
#line 19 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
 ...
 & 19) )
  if (anyExceptions()) return
#line 20 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
...
#line 39 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
  call assertEqual((/2._r8,5._r8,8._r8,11._r8/), ans, &
 & location=SourceLocation( &
 & 'test_betr_mathfunc.pfunit', &
 & 39) )
  if (anyExceptions()) return
#line 40 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
...
#line 86 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
  call assertEqual(0, errinfo, &
 & location=SourceLocation( &
 & 'test_betr_mathfunc.pfunit', &
 & 86) )
  if (anyExceptions()) return
#line 87 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
#line 87 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
 ...
 & 87) )
  if (anyExceptions()) return
#line 88 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
...
#line 101 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
  call assertEqual(0,errinfo, &
 & location=SourceLocation( &
 & 'test_betr_mathfunc.pfunit', &
 & 101) )
  if (anyExceptions()) return
#line 102 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
...
#line 141 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
  call assertEqual(rmat11,rmat1, &
 & location=SourceLocation( &
 & 'test_betr_mathfunc.pfunit', &
 & 141) )
  if (anyExceptions()) return
#line 142 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
#line 142 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"
 ...
 & 142) )
  if (anyExceptions()) return
#line 143 "/global/homes/j/jingtao/ReSOM/sbetr/src/betr/betr_math/tests/test_betr_mathfunc.pfunit"

  end subroutine test_layer_adjust
end module test_mathfunc_module

module Wraptest_mathfunc_module
   use pFUnit_mod
   use test_mathfunc_module
   implicit none
   private
...
end module Wraptest_mathfunc_module

function test_mathfunc_module_suite() result(suite)
   use pFUnit_mod
   use test_mathfunc_module
   use Wraptest_mathfunc_module
   type (TestSuite) :: suite

   integer, allocatable :: npes(:)

   suite = newTestSuite('test_mathfunc_module_suite')

   call suite%addTest(newTestMethod('test_heavyside', test_heavyside))


end function test_mathfunc_module_suite
